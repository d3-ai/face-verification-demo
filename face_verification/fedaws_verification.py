...
from common.parameter import parameters_to_ndarrays
...
parser.add_argument("--criterion", type=str, required=False, default="CCL", choices=["CCL"], help="Criterion of classification performance")
