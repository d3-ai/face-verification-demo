...
from common import ndarrays_to_parameters,parameters_to_ndarrays, Parameters, Scalar, NDArrays
...
parser.add_argument("--pretrained", type=str, required=False, choices=["IMAGENET1K_V1", "None", "CelebA"], default=None, help="pretraing recipe")
parser.add_argument("--fixed_embeddings", type=int, required=False, choices=[0, 1], default=0, help="pretraing recipe")
