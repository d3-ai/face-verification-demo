...
class CIFAR10_truncated(Dataset):
    ...
    NIID-Bench
    """
    def __init__(self, root: Path, id: str = None, train: bool = True, target: str = None, transform=None, target_transform=None, download=False):        
        self.id = id
        self.train = train
        self.transform = transform
        self.target_transform = target_transform
    ...
    def __build_truncated_dataset__(self):
        cifar_dataobj = CIFAR10(self.data_root, self.train, self.transform, self.target_transform, self.download)
